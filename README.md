...
Challenges:
- Importing YouTube .jar file.
  - Had to open build.gradle, modify it, then undo the modifications and click "sync" for AS to recognize the library.
- Picasso w/ viewholder pattern
  - took many iterations to get the images loading in their proper cells when scrolling quickly
